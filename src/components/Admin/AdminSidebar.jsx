...
const AdminSidebar = ({isOpen}) => {
    ...
    return (
        isOpen && <div className='transformation flex flex-col justify-between items-start bg-[#FFFFFF] h-[100vh] w-[250px] py-4 pt-20 shadow-lg fixed top-0 left-0 z-50'>
            ...
            <div className='w-full px-4'>
                ...
                <button className='bg-[rgba(75,0,130,0.15)] h-[44px] w-full text-[16px] font-normal text-[#4B0082] rounded-[8px] cursor-pointer flex items-center pl-3 gap-x-2'>
                    <MdLogout size={20} />
                    Logout
                </button>
            </div>

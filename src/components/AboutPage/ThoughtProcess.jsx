...
import thoughtImg1 from '../../assets/Rectangle 60.svg'
import thoughtImg2 from '../../assets/Rectangle 60.svg'
import thoughtImg3 from '../../assets/Rectangle 60.svg'
// import thoughtImg4 from '../assets/Frame 50.svg'
// import thoughtImg5 from '../assets/Frame 51.svg'
// import thoughtImg6 from '../assets/Frame 52.svg'
...
const ThoughtProcess = () => {
    return (
        <div>
            ...
            <div>
                <div className='flex gap-16 items-start justify-between mb-[7rem]'>
                    <div>
                        <h1 className='mb-10 font-bold text-[24px]'>Life is hard already, getting into tech shouldn't</h1>
                ...
                <div>
                    <div className='flex gap-16 items-start justify-between mb-[7rem]'>
                        <img src={thoughtImg1} alt="techlift-thoughts"  className='transform rotate-345'/>
                        <div>
                            <h1 className='mb-10 font-bold text-[24px]'>Networking is the new goldmine in tech, tap it</h1>
                            <p className='max-w-[40rem]'>
                ...
                <div>
                    <div className='flex gap-16 items-start justify-between mb-[7rem]'>
                        <div>
                            <h1 className='mb-10 font-bold text-[24px]'>Learn, Connect And Grow</h1>
                            <p className='max-w-[40rem]'>

  ...
  return (
    <div className="flex flex-col justify-center items-center py-10 px-8 md:px-20">
      <div className="text-center mb-6">
        ...
        <p className='font-normal text-[20px]'>Here are a few success stories from our community members whose lives we have impacted</p>
      </div>
        ...
        >
          {membersData.map((item, index) => (
            <SwiperSlide key={index} className="w-full ">
              <div className="flex flex-col justify-center gap-4 items-start p-4 w-[300px] h-[350px] bg-gray-300 rounded-lg shadow-md">
